          ...
          <div class="row">
            ...
            <div class="col-md-10 col-sm-8 container-fluid">
              ...
              <p class="d-flex justify-content-center gap-2">
                <button class="btn CorVerdeEstado" id="buton-lerMais" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample3"><strong>
              ...
              <div class="container wow fadeIn" data-wow-delay="0.3s">
                <iframe width="600" height="343" src="https://www.youtube.com/embed/nGBDxmDgMXU" title="5S - A Origem" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
              <!-- VÍDEO DO YOUTUBE -->
              ...
              <!-- Parágrafo com a biblioteca de animação  -->
              <p class="wow fadeIn" data-wow-delay="0.3s">O <strong> senso de organização </strong> é utilizado, em
                geral, para manter os objetos
              ...
              <!-- Parágrafo com a biblioteca de animação  -->
              <p class="wow fadeIn" data-wow-delay="0.3">A falta de prioridade é outro claro motivo pelo qual as
                pessoas têm dificuldade de dizer
              ...
              <!-- Parágrafo com a biblioteca de animação  -->
              <p class="wow fadeIn" data-wow-delay="0.3s">O <strong> senso de limpeza </strong>, como o próprio nome
                indica, está relacionado com a
              ...
              <!-- Parágrafo com a biblioteca de animação  -->
              <p class="wow fadeIn" data-wow-delay="0.3s">Para que você possa ter uma boa gestão de seu <strong>
                  espaço virtual </strong> e,
              ...
              <!-- Parágrafo com a biblioteca de animação  -->
              <p class="wow fadeIn" data-wow-delay="0.3s">Os sensos de <strong> padronização e disciplina </strong>
                estão vinculados à manutenção
              ...
              <div class="start_btn"><button id="openModalBtn"><i class="icone fa-solid fa-puzzle-piece"></i>CLIQUE E TESTE SEUS
              ...
              <p class="wow fadeIn" data-wow-delay="0.3s">É preciso também ressaltar que, objetivos requerem ação.
                Para que o planejado possa se realizar, você tem que tomar medidas diárias que o aproximem do que você tem
                em mente. “As metas têm um preço - não necessariamente monetário, mas as metas precisarão que você invista
