                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <!-- IMAGEM NO SITE  -->
                            ...
                            <div class="text-center wow fadeIn" data-wow-delay="0.3s" id="img-left">
                            ...
                            <p class="wow fadeIn" data-wow-delay="0.3s" id="text-left">Nossos dias e horas são basicamente definidos
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s">A tecnologia diminuiu o tempo necessário para
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s">Por essa razão, destacamos entre as vantagens da
                                gestão do tempo:
                            </p>
                            <!--  Fim do Parágrafo com a biblioteca de animação -->
                            ...
                            <ol class="wow fadeIn" data-wow-delay="0.3s" id="txt_final">
                                ...
                                <li>Planejamento para atingir metas e aumentar a produtividade e eficiência do tempo;
                                </li>
