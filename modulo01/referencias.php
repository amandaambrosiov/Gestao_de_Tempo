            ...
            <div class="main-content container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <p class="Texto wow fadeIn" data-wow-delay="0.3s"> <i class="bi bi-book me-2"></i>ALLEN, Steve.
                            <strong> Aprenda como
                        ...
                        <p class="Texto wow fadeIn" data-wow-delay="0.3s"> <i class="bi bi-book me-2"></i>JONES, Ryan.
                            <strong> Produtividade para
                        ...
                        <p class="Texto wow fadeIn" data-wow-delay="0.3s"> <i class="bi bi-book me-2"></i>JLAWRENCE,
                            Steven. <strong> O Poder da Execução
                                de Metas</strong> <a
                        ...
                        <p class="Texto wow fadeIn" data-wow-delay="0.3s"> <i class="bi bi-book me-2"></i>MOURA,
                            Jaqueline. <strong> O poder do Não.
                        ...
                        <p class="Texto wow fadeIn" data-wow-delay="0.3s"> <i class="bi bi-book me-2"></i>RIBEIRO,
                            Haroldo. <strong> A Bíblia do 5S, da
